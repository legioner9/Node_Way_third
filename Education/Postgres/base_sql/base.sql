...
INSERT INTO products VALUES (1,'Celeron 1.8','1595.00',10,3.6,'Процессор Celeron® 1.8GHz, 128kb, 478-PGA, 400Mhz, OEM 0.18',1);
INSERT INTO products VALUES (2,'Celeron 2.0GHz','1969.00',2,3.7,'Процессор Celeron® 2.0GHz, 128KB, 478-PGA, 400MHz, OEM ',1);
INSERT INTO products VALUES (3,'Celeron 2.4GHz','2109.00',4,3.9,'Процессор Celeron® 2.4GHz, 128kb, 478-PGA, 400Mhz, OEM ',1);
INSERT INTO products VALUES (4,'Celeron D 320 2.4GHz','1962.00',1,4.1,'Процессор Celeron® D 320 2.4GHz, 256kb, 478-PGA, 533Mhz, OEM',1);
INSERT INTO products VALUES (5,'Celeron D 325 2.53GHz','2747.00',6,4.1,'Процессор Celeron® D 325 2.53GHz, 256kb, 478-PGA, 533Mhz, OEM ',1);
INSERT INTO products VALUES (6,'Celeron D 315 2.26GHz','1880.00',6,4.1,'Процессор Celeron® D 315 2.26GHz, 256kb, 478-PGA, 533Mhz, OEM ',1);
INSERT INTO products VALUES (7,'Intel Pentium 4 3.2GHz','7259.00',5,4.5,'Процессор Intel® Pentium®4 3.2GHz, 1Mb, 478-PGA, 800Mhz, Hyper-Threading, OEM ',1);
INSERT INTO products VALUES (8,'Intel Pentium 4 3.0GHz','6147.00',1,4.6,'Процессор Intel® Pentium®4 3.0GHz, 512Kb, 478-PGA, 800Mhz, Hyper-Threading, OEM ',1);
INSERT INTO products VALUES (9,'Intel Pentium 4 3.0GHz','5673.00',12,4.5,'Процессор Intel® Pentium®4 3.0GHz, 1Mb, 478-PGA, 800Mhz, Hyper-Treading, OEM ',1);
...
INSERT INTO users VALUES (1,'Иванов','Валерьевич','Александр','58-98-78','ivanov@email.ru',NULL,'active');
INSERT INTO users VALUES (2,'Лосев','Иванович','Сергей','9057777777','losev@email.ru',NULL,'passive');
INSERT INTO users VALUES (3,'Симдянов','Вячеславович','Игорь','9056666100','simdyanov@softtime.ru','http://www.softtime.ru/','active');
INSERT INTO users VALUES (4,'Кузнецов','Валерьевич','Максим',NULL,'kuznetsov@softtime.ru','http://www.softtime.ru','active');
INSERT INTO users VALUES (5,'Нехорошев','Юрьевич','Анатолий',NULL,NULL,NULL,'lock');
INSERT INTO users VALUES (6,'Корнеев','Александрович','Александр','89-78-36','korneev@domen.ru',NULL,'gold');