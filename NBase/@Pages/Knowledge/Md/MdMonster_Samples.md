...
Сноски
    Сноски и примечания[^3] задаются так[^4]
...
[^3]: Все сноски отображаются в конце страницы
[^4]: Просто не так ли?)
...
Такое совмещение создает картинку, щелчок по которой переместит вас на указанную
