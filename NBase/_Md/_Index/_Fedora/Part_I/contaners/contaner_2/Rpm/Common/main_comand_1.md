...
* [Как настроить репозитории программного обеспечения в Fedora?](#как-настроить-репозитории-программного-обеспечения-в-fedora)
	...
	* [Чтобы добавить и включить новый репозиторий,](#чтобы-добавить-и-включить-новый-репозиторий)
	* [Чтобы включить/отключить репозиторий DNF](#чтобы-включитьотключить-репозиторий-dnf)
	* [включать или отключать более одного репозитория](#включать-или-отключать-более-одного-репозитория)
	* [навсегда включить определенный репозиторий](#навсегда-включить-определенный-репозиторий)
	* [Чтобы навсегда отключить](#чтобы-навсегда-отключить)
...
![Add-and-Enable-DNF-Repo](_src/Add-and-Enable-DNF-Repo.png)
...
, например, при попытке установить из него пакет, используйте параметр —enablerepo или —disablerepo:
...
![Install-Package-from-Enabled-Repository](_src/Install-Package-from-Enabled-Repository.png)
...
Таким же образом вы можете как включать, так и отключать репозитории непосредственно в одной команде:
...
, используйте параметр —set-enabled.
...
![Permanently-Enable-DNF-Repo](_src/Permanently-Enable-DNF-Repo.png)
...
определенный репозиторий, используйте параметр —set-disabled.
