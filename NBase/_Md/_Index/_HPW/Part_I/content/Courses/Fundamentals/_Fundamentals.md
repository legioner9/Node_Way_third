...
- [Введение в программирование](https://youtu.be/5Gt61EX6HZ4) => [intro](intro/1.md)
...
- [Введение в программирование, продолжение](https://youtu.be/PzlLXQ3RaDs) => [intro_2](intro_2/1.md)
...
- Семинар: [Обсуждение плана и материалов курса](https://youtu.be/bQMTbRWrteU) =>  [discuss_plan](discuss_plan/1.md)
- [Настройка среды: Node.js, npm, git, eslint](https://youtu.be/hSyA7tcNaCE) => [environment_setup](environment_setup.md)
...
- [Базовый синтаксис JavaScript](https://youtu.be/xJn3k1f4BiM) =>
  [basic_sintax](basic_sintax\1.md)
   NBase\_Md\_Index\_HPW\Part_I\content\Courses\Fundamentals\basic_sintax\1.md
...
- Семинар: [Базовый синтаксис языка JavaScript](https://youtu.be/PGqjTXQe_qw) => [basic_sintax_seminar](basic_sintax_seminar\1.md)

- Семинар: [Автоматическая проверка лабораторных работ](https://youtu.be/M4KpG0LEAyA)


- [Функции, лямбды, контексты, замыкания в JavaScript](https://youtu.be/pn5myCmpV2U) =>[funcLambdConextClosure](funcLambdConextClosure\1.md)
...
[arrObjClassProto](arrObjClassProto\1.md)
...
[LagnuagesProgramming](LagnuagesProgramming/readme.md)
...
[partialAppAndCurry](partialAppAndCurry/readme.md)
...
[higherOrderFuncCallbackEvents](higherOrderFuncCallbackEvents/readme.md)
