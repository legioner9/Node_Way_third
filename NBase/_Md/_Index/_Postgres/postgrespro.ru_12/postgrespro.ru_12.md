...
[textsearch](\content\textsearch.md)
...
[performance-tips](\content\performance-tips.md)

## [Параллельный запрос](https://postgrespro.ru/docs/postgrespro/12/parallel-query)

[parallel-query](\content\parallel-query.md)
